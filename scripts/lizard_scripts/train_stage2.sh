#!/bin/bash
# Stage2: SFT with linear attention (LizardAttention) + LoRA.
# Loads a stage1 checkpoint, replaces all softmax self-attn with LizardAttention,
# then fine-tunes with LoRA using standard token-prediction loss.
# Run from the VILA root directory: bash scripts/lizard_scripts/train_stage2.sh
...
# Base model (same as used in stage1)
...
# Usage: TEST_MODE=1 bash scripts/lizard_scripts/train_stage2.sh
# ============================================================
