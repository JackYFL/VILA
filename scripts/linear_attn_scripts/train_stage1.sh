#!/bin/bash
# Stage1: distill vanilla (non-gated) linear attention (VanillaLinearAttention)
# on LLaVA-OneVision-Data-processed (image SFT stage).
# Run from the VILA root directory: bash scripts/linear_attn_scripts/train_stage1.sh
...
# Usage: TEST_MODE=1 bash scripts/linear_attn_scripts/train_stage1.sh
# ============================================================
